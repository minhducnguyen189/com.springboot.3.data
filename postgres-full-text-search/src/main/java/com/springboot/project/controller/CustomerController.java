...
public class CustomerController implements CustomerApi {
  ...
  @Override
  public ResponseEntity<CustomerFilterResponse> searchCustomers(
      String keyword, Integer pageSize, Integer pageNumber) {
    CustomerFilterResult customerFilterResult =
        this.customerService.searchCustomer(keyword, pageSize, pageNumber);
    CustomerFilterResponse customerFilterResponse =
        AutoCustomerMapper.MAPPER.mapToCustomerFilterResponse(customerFilterResult);
