...
public class CustomerController implements CustomerApi {
  ...
  @Override
  public ResponseEntity<List<CustomerDetail>> filterCustomers(
    ...
    List<CustomerDetail> customerResponses =
        AutoCustomerMapper.MAPPER.mapToCustomerDetails(customers);
  ...
  @Override
  public ResponseEntity<CustomerDetail> updateCustomer(
      UUID customerId, CustomerDetail customerDetail) {
    ...
    return new ResponseEntity<>(
        AutoCustomerMapper.MAPPER.mapToCustomerDetail(customer), HttpStatus.OK);
  }
}
