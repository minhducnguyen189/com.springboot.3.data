...
public class CustomerController implements CustomerApi {
  ...
  @Override
  public ResponseEntity<LoyaltyCardResponse> addloyaltyCard(
      UUID customerId, LoyaltyCardRequest loyaltyCardRequest) {
    LoyaltyCardResponse loyaltyCardResponse =
        this.customerService.createLoyaltyCard(customerId, loyaltyCardRequest);
  ...
  public ResponseEntity<CustomerFilterResponse> filterCustomers(
    ...
    CustomerFilterResponse customerFilterResponse =
        this.customerService.filterCustomerWithEM(customerFilter);
